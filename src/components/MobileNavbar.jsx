                    ...
                    <button
                      ...
                      onClick={() =>
                        setInnerActiveDropdown(
                          innerActiveDropdown === item.id ? null : item.id
                        )
                      }
                    >
                      <RotatingIcon
                        id={`icon${item.id}`} // Unique ID based on item ID
                        rotated={rotatedStates[`icon${item.id}`]} // Pass the state for the icon
                        toggleRotation={() => toggleRotation(`icon${item.id}`)} // Toggle state for the icon
                      />
                    </button>
                  </div>
                  {innerActiveDropdown === item.id && (
                    <div className="ml-4">
